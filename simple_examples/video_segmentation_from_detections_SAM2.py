...
def main():
    ...
    shared_state = {"objects": [], "lock": threading.Lock()}
    ...
    # Using XVID in .avi wrapper for highest PowerPoint compatibility
    fourcc = cv2.VideoWriter_fourcc(*'XVID')
    video_writer = None
    next_write_time = 0.0
    print("Video recording ready. The file will be finalized on exit.")
    ...
    try:
        while True:
            ...
            if video_writer is None:
                ...
                video_writer = cv2.VideoWriter('output_segmentation_SAM2_2.avi', fourcc, 30.0, (w_disp, h_disp))
